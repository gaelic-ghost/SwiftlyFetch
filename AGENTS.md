...
- Avoid adding unnecessary dependency-provenance detail or switching to branch or revision-based requirements unless the user explicitly asks for that level of control.
